...
ax.legend( (rects0[0], rects1[0], rects2[0], rects4[0], rects6[0], rects8[0], rects3[0]), ('Kira-SE-v2', 'Kira-SE-v1', 'Distributed (no resilience)', 'Replicated', 'Striped (no resilience)', 'Striped Replicated', 'Metadata Overhead') )
