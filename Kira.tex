...
Over the previously implemented Kira with Spark's Scala interface, we migrate to the Python interface 
for increased uptake in the astronomy community. Moreover, the improve the data structure and layout
and minimize the data copy during inter-language communication. To differentiate the two implementations,
...
Kira-SE-v1 attributes to the native data layout between Spark's Python interface and the SEP library
as well as the minimized data copy between SEP library and the core C library. 
...
Both the Kira-SE-v1 and Kira-SE-v2 show a close linear scalability.
