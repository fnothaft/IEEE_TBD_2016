...
\IEEEcompsocthanksitem Frank~Austin~Nothaft, David~A.~Patterson are with the AMP and ASPIRE Labs, UC Berkeley
\IEEEcompsocthanksitem Evan~Sparks is with the AMPLab, UC Berkeley
